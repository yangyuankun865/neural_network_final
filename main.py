...
def get_args_parser():
    ...
    parser.add_argument('--cooldown-epochs', type=int, default=1, metavar='N',
...
def main(args):
    ...
    for seed in [100,200,300,400,500,600]: 
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            writer.add_scalar(str(seed)+"/train_loss", train_stats['loss'], epoch)
            writer.add_scalar(str(seed)+"/val_loss", test_stats['loss'], epoch)
            writer.add_scalar(str(seed)+"/val_acc", test_stats['acc1'], epoch)
